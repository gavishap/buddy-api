...
class Collections:
    ...
    OWNERS = "owners"  # Collection for owner users (contains both auth and profile data)
    SITTERS = "sitter_users"  # Collection for sitter users (contains both auth and profile data)
    PETS = "pets"
    BOOKINGS = "bookings"
